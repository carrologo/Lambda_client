...
export class SupabaseClientRepository implements ClientRepository {
  ...
  private sortClientsByUpcomingBirthday(
    clients: Client[],
    isAscending: boolean
  ): Client[] {
    ...
    return [...clients].sort((a, b) => {
      ...
      const daysUntilA = this.calculateDaysUntilBirthday(
        monthA,
        dayA,
        currentMonth,
        currentDay
      );
      const daysUntilB = this.calculateDaysUntilBirthday(
        monthB,
        dayB,
        currentMonth,
        currentDay
  ...
  private calculateDaysUntilBirthday(
    birthMonth: number,
    birthDay: number,
    currentMonth: number,
    currentDay: number
